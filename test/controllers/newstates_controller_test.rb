...
class NewstatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newstate" do
    assert_difference('Newstate.count') do
      post newstates_url, params: { newstate: { country: @newstate.country, statename: @newstate.statename } }
    end
  ...
  test "should update newstate" do
    patch newstate_url(@newstate), params: { newstate: { country: @newstate.country, statename: @newstate.statename } }
